      ...
      <div className="flex-1 flex flex-col items-center px-6 pt-6 stagger-fade">
        ...
        <div className="w-full bg-white/80 rounded-[32px] shadow-[0px_10px_30px_rgba(0,123,255,0.05)] p-6 backdrop-blur-[10px]">
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            <div>
              <label className="text-[#414754] text-sm font-semibold block mb-1">Nama Lengkap</label>
            ...
            <div>
              <label className="text-[#414754] text-sm font-semibold block mb-1">Email</label>
            ...
            <div>
              <label className="text-[#414754] text-sm font-semibold block mb-1">Nomor Telepon</label>
            ...
            <div>
              <label className="text-[#414754] text-sm font-semibold block mb-1">Password</label>
              <div className="relative">
                ...
                <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-4 top-1/2 -translate-y-1/2 text-[#717786]">
          ...
          <button onClick={handleGoogle} className="w-full flex items-center justify-center gap-2 py-3 border border-[#9A9A9A] rounded-full text-sm text-[#414754] hover:bg-gray-50">
