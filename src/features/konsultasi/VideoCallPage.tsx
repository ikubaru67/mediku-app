    ...
    <div className="min-h-screen bg-black relative flex flex-col overflow-hidden">
      ...
      <div className="relative z-10 px-5 pt-12 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <button onClick={() => navigate(-1)} className="w-10 h-10 rounded-full bg-[rgba(255,255,255,0.15)] backdrop-blur-[12px] outline-1 outline-[rgba(255,255,255,0.20)] flex items-center justify-center">
        ...
        <button className="px-4 py-2 rounded-full bg-[rgba(255,255,255,0.15)] backdrop-blur-[12px] outline-1 outline-[rgba(255,255,255,0.20)]">
      ...
      <div className="relative z-10 mt-auto px-5 pb-12 flex flex-col items-center gap-8">
        ...
        <div className="flex items-center gap-4 px-4 py-4 rounded-[40px] bg-[rgba(255,255,255,0.15)] backdrop-blur-[12px] outline-1 outline-[rgba(255,255,255,0.20)]">
          {/* Mute */}
          <button onClick={() => setMuted(!muted)} className="w-14 h-14 rounded-full flex items-center justify-center bg-[rgba(255,255,255,0.15)] backdrop-blur-[12px] outline-1 outline-[rgba(255,255,255,0.20)]">
            {muted ? (
          ...
          {/* Chat */}
          <button onClick={() => setShowChat(true)} className="w-14 h-14 rounded-full flex items-center justify-center bg-[rgba(255,255,255,0.15)] backdrop-blur-[12px] outline-1 outline-[rgba(255,255,255,0.20)]">
          ...
          {/* End call */}
          <button onClick={handleEndCall} className="w-16 h-16 rounded-full bg-[#BA1A1A] flex items-center justify-center shadow-[0px_4px_6px_-4px_rgba(186,26,26,0.40),0px_10px_15px_-3px_rgba(186,26,26,0.40)]">
          ...
          {/* Speaker */}
          <button onClick={() => setSpeaker(!speaker)} className={`w-14 h-14 rounded-full flex items-center justify-center backdrop-blur-[12px] outline-1 outline-[rgba(255,255,255,0.20)] ${speaker ? 'bg-[rgba(255,255,255,0.15)]' : 'bg-[rgba(255,255,255,0.15)]'}`}>
          ...
          {/* Camera switch */}
          <button onClick={() => setCamOn(!camOn)} className="w-14 h-14 rounded-full flex items-center justify-center bg-[rgba(255,255,255,0.15)] backdrop-blur-[12px] outline-1 outline-[rgba(255,255,255,0.20)] relative">
        ...
        <div className="fixed inset-0 z-50 flex flex-col justify-end items-center">
          ...
          <div className="relative w-full max-w-[430px] bg-[rgba(247,249,252,0.95)] backdrop-blur-[12px] rounded-t-[32px] max-h-[60vh] flex flex-col animate-slide-up">
            <div className="flex items-center justify-between px-5 pt-4 pb-2">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-full overflow-hidden bg-[#F2F4F7]">
                  {psikolog ? <img src={(IMAGES.videoBgMap as any)[psikolog.name] || IMAGES.videoBg} alt="" className="w-full h-full object-cover" /> : null}
                </div>
                <div>
            ...
            <div className="px-4 py-3 border-t border-[rgba(193,198,215,0.30)] flex items-center gap-2">
              ...
              <button onClick={sendChat} className="w-9 h-9 bg-[#0059BB] rounded-full flex items-center justify-center shrink-0">
